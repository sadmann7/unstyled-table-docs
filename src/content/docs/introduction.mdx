...
Learn more about headless interfaces in react [here](https://www.merrickchristensen.com/articles/headless-user-interface-components/).
...
- [Tanstack Table v8](https://tanstack.com/table/v8/docs) - For the core and feature APIs.
- [shadcn/ui](https://ui.shadcn.com/docs) - For the template, and these components: `SidebarNav`, `Pager`, `Callout`, and `Mdx`.
- [T3 Env](https://env.t3.gg/docs/introduction) - For the codeblock styling.
