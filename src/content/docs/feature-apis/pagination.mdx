---
title: Pagination
description: The ability to split up large data sets into smaller chunks.
---
...
- [Pagination](https://tanstack.com/table/v8/docs/api/features/pagination) - TanStack Table `v8` Docs
