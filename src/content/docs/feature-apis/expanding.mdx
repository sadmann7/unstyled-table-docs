---
title: Expanding
description: The ability to expand rows to show additional information.
---
...
- [Expanding](https://tanstack.com/table/v8/docs/api/features/expanding) - TanStack Table `v8` Docs
