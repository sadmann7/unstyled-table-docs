---
title: ColumnDef
description: Column definitions are plain objects that describe the configuration of columns in a table.
---
...
- [Column Def](https://tanstack.com/table/v8/docs/api/core/column-def) - TanStack Table `v8` Docs
