...
- `children` - The children of the body cell renderer.
- `cell` - See [cell](/docs/core-concepts/cell).
- `props` - The props passed to the body cell renderer.

## Preview

<Example renderer="bodyCell" />
