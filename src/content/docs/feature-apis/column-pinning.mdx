...
description: The ability to pin columns to the left or right of the table.
---
...
- [Column Pinning](https://tanstack.com/table/v8/docs/api/features/column-pinning) - TanStack Table `v8` Docs
