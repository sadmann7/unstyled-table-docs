...
The header cell renderer receives the following props:

- `children` - The children of the header cell renderer.
- `props` - The props passed to the header cell renderer.

## Preview

<Example renderer="headerCell" />
