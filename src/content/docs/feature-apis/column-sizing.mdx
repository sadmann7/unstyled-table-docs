---
title: Column Sizing
description: The ability to resize columns by dragging the column header border.
---
...
- [Column Sizing](https://tanstack.com/table/v8/docs/api/features/column-sizing) - TanStack Table `v8` Docs
