...
description: This component renders the body cells of the table.
---

## Props

The pagination button renderer receives the following props:
...
<Example renderer="paginationButton" />
