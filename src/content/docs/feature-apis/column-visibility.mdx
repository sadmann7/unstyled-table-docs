...
description: The ability to show/hide columns in the table.
---
...
- [Column Visibility](https://tanstack.com/table/v8/docs/api/features/column-visibility) - TanStack Table `v8` Docs
